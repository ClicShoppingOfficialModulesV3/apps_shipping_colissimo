    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-7 text-md-right"><?php echo HTML::button($CLICSHOPPING_Colissimo->getDef('button_sort_order'), null, CLICSHOPPING::link(null, 'A&Configuration\Modules&Modules&set=shipping'), 'primary'); ?>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-12">
          <?php
            ...
            if ($CLICSHOPPING_Colissimo->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
              echo '<span class="float-end">' . HTML::button($CLICSHOPPING_Colissimo->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-toggle="modal" data-target="#ppUninstallModal"']) . '</span>';
            }
          ?>
