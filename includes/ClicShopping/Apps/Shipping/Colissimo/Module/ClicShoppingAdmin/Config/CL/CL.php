<?php
  ...
  namespace ClicShopping\Apps\Shipping\Colissimo\Module\ClicShoppingAdmin\Config\CL;

  class CL extends \ClicShopping\Apps\Shipping\Colissimo\Module\ClicShoppingAdmin\Config\ConfigAbstract
  {

    protected $pm_code = 'Colissimo';
