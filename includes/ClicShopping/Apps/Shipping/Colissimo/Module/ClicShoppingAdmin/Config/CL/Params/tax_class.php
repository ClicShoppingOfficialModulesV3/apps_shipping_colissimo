<?php
  ...
  class tax_class extends \ClicShopping\Apps\Shipping\Colissimo\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
  {
    public $default = '';
...
//    public $use_func = 'clic_cfg_use_get_tax_class_title';
    ...
    {
      $this->title = $this->app->getDef('cfg_colissimo_tax_class_title');
      $this->description = $this->app->getDef('cfg_colissimo_tax_class_desc');
    }
    ...
    public function getInputField()
    {
      ...
      $tax_class_array = [
        [
          'id' => '0',
          'text' => $this->app->getDef('cfg_colissimo_zone_none')
        ]
      ];
