<?php
  ...
  class zone extends \ClicShopping\Apps\Shipping\Colissimo\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
  {
    public $default = '0';
    ...
    {
      $this->title = $this->app->getDef('cfg_colissimo_zone_title');
      $this->description = $this->app->getDef('cfg_colissimo_zone_desc');
    }
